Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.framework = 'SystemConfiguration','CFNetwork','Security','AVFoundation','CoreLocation','CoreTelephony','MobileCoreServices','AdSupport'
  ...
  s.subspec 'Core' do |core|
    ...
    core.vendored_libraries = 'libGeTuiSdk-1.6.2.0.a'
  end
